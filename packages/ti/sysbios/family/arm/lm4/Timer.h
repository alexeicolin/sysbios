...
#define ti_sysbios_family_arm_lm4_Timer___VERS 150
...
#ifdef ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock__D
#define ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock (ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock__D)
#else
#define ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock (ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock__C)
typedef xdc_Bool CT__ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock;
__extern __FAR__ const CT__ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock__C;
#endif
...
__extern xdc_Void ti_sysbios_family_arm_lm4_Timer_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
{
    if (dst) {
        ti_sysbios_family_arm_lm4_Timer_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_family_arm_lm4_Timer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
#define Timer_enableArcmGpTimerClock ti_sysbios_family_arm_lm4_Timer_enableArcmGpTimerClock
