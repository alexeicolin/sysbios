...
#define ti_sysbios_smp_SysStd___VERS 150
...
__extern xdc_Void ti_sysbios_smp_SysStd_abort__E( xdc_String str );
xdc__CODESECT(ti_sysbios_smp_SysStd_abort__F, "ti_sysbios_smp_SysStd_abort")
__extern xdc_Void ti_sysbios_smp_SysStd_abort__F( xdc_String str );
__extern xdc_Void ti_sysbios_smp_SysStd_abort__R( xdc_String str );
