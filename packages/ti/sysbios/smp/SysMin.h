...
#define ti_sysbios_smp_SysMin___VERS 150
...
__extern xdc_Void ti_sysbios_smp_SysMin_abort__E( xdc_String str );
xdc__CODESECT(ti_sysbios_smp_SysMin_abort__F, "ti_sysbios_smp_SysMin_abort")
__extern xdc_Void ti_sysbios_smp_SysMin_abort__F( xdc_String str );
__extern xdc_Void ti_sysbios_smp_SysMin_abort__R( xdc_String str );
