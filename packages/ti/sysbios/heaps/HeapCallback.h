...
#define ti_sysbios_heaps_HeapCallback___VERS 150
...
__extern xdc_Void ti_sysbios_heaps_HeapCallback_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
{
    if (dst) {
        ti_sysbios_heaps_HeapCallback_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_heaps_HeapCallback_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
